...
nmap -oN ./nmap-scan-results.txt --script vulners.nse -sV ${ip} -p-  > /dev/null 2>&1 && zenity --info --text="Nmap Scan On ${ip} Complete. Results saved to nmap-scan-results.txt."
